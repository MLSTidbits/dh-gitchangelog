...
DESCRIPTION = Debian changelog from git commit messages -
LONG_DESCRIPTION = Generate a Debian style changelog from git commit messages used in Debian/Ubuntu packages.
